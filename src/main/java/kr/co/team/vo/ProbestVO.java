...
public class ProbestVO {
	private int id,price,halin,juk,su,baesong,pstar,readnum;
	private String pcode,pimg,cimg,title,writeday,dcode;
	private String size,color,stock;

...
<section>
	...
	<span id="menu">
		...
		<a href="faq_list_etc?gubun=0" id="sub"> 입금/결제 </a>
		<a href="faq_list_etc?gubun=1" id="sub"> 배송 </a>
		<a href="faq_list_etc?gubun=2" id="sub"> 반품/교환 </a>
		<a href="faq_list_etc?gubun=3" id="sub"> 주문 </a>
		<a href="faq_list_etc?gubun=4" id="sub"> 사이트이용 </a>
		<a href="faq_list_etc?gubun=5" id="sub"> 기타 </a>
	</span>
